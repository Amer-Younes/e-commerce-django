...
class Product(models.Model):
    ...
    image = models.ImageField( upload_to=user_directory_path  , default="product.jpg" , blank=True, null=True)
...
class CartOrder(models.Model):
    ...
    sku = ShortUUIDField(blank = True, null=True , length = 5 , max_length = 20 , prefix="SKU" , alphabet="1234567890")
